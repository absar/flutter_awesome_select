...
* Upgrade kotlin plugin from 1.7.20 to 1.8.22 and Gradle from 8.2 to 8.3, to sync it with Flutter 3.24
* Upgrade kotlin plugin from 1.8.22 to 2.1.0 and Gradle from 8.3 to 8.9
